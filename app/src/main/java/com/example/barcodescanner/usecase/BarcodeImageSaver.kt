...
class BarcodeImageSaver(private val barcodeImageGenerator: BarcodeImageGenerator) {
    ...
    fun saveImageToPublicDirectory(context: Context, barcode: ParsedBarcode): String? {
        try {
            ...
            val uri = contentResolver.insert(Images.Media.EXTERNAL_CONTENT_URI, values) ?: return null
